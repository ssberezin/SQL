...
(
	...
	[Сirculation] int  check([Сirculation]>0),
	[PageCount] int not null check([PageCount]>0),
	[DateOfPubl] date ,	
	[Price] money ,
	[IsPublish] nvarchar(3) not null 
...
INSERT into [Books] VALUES  (4,1,'Невеста демона',150000,310,'2017.2.18',25,'Yes'),
							(4,1,'Крылья феникса',132000,325,'2017.12.13',24,'Yes'),
							(4,2,'Академия магии',14100,250,'2018.3.12',23,'Yes'),
							(3,3,'Я танкист',152000,600,'2018.2.10',25,'Yes'),
							(3,3,'Я летчик',93000,310,'2017.4.28',22,'Yes'),
							(2,2,'Дочь воина, или Кадеты не сдаются',95000,450,'2010.8.22',20,'No'),
							(2,2,'Хелл. Обучение наемницы',45000,280,'2013.4.24',21,'Yes'),
							(1,4,'Корпорация',133000,610,'2017.4.19',30,'No'),
							(3,4,'Протопип',85000,215,'2018.2.10',20.6,'No'),
							(3,3,'Вечный',45000,310,'2018.7.11',21.9,'Yes');
